...
| damageAdd | add, a | 光环持有者所造成伤害的数值所被加上的具体数值（4.11 支持[占位符](/技能/占位符)与[变量](/技能/变量)） | 0 |
| damageMultiplier | multiplier, m | 光环持有者所造成伤害的数值所被乘以的百分比（4.11 支持[占位符](/技能/占位符)与[变量](/技能/变量)） | 1 |
