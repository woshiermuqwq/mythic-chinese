...
Mythic实体名:
  Type: 实体种类
  Drops:
  - 原版物品ID/Mythic物品内部名/exp/掉落表内部名 数量 几率
  - 原版物品ID/Mythic物品内部名/exp/掉落表内部名 数量 几率
  - ...
```

**&lt;原版物品ID/Mythic物品内部名/exp/掉落表内部名&gt;**  
原版物品ID/Mythic物品内部名/exp/掉落表内部名,物品可以是MythicMobs物品.
...
| **mythicdrop &lt;物品&gt;** | 掉落 Mythic物品 | `- Mythic物品内部ID 1 1`（mythicdrop可省略）   |
