...
| [Blocking](/条件/blocking)                             | 实体     | 是否正在使用盾格挡                                        |
| [Burning](/条件/burning)                               | 实体     | 是否正在燃烧 |
| [Children](/条件/children)                             | 实体     | 若拥有指定数量子系实体                                                     |
| [Color](/条件/color)                                   | 实体     | 若实体颜色为 |
| [Crouching](/条件/crouching)                           | 实体     | 是否保持蹲下                                               |
| [Cuboid](/条件/cuboid)                                 | 比较     | 是否在俩坐标点点所形成的区域内                |
...
| [HasAuraStacks](/条件/hasaurastacks)                   | 实体     | 若实体拥有指定光环的指定层数                              |
| [HasCurrency](/条件/hascurrency)                       | 实体     | 若实体金钱在指定范围内                                        |
| [HasInventorySpace](/条件/hasinventoryspace)           | 实体     | 若实体背包内的空槽≤指定数值                                 |
...
| [HasPotionEffect](/条件/haspotioneffect)               | 实体     | 若实体拥有状态效果                                              |
...
| [Level](/条件/level)                                   | 实体     | 若实体的等级(非原版)为                                                         |
...
| [PlayerNotWithin](/条件/playernotwithin)               | 位置     | 若玩家与实体的距离不在指定范围内                                     |
| [PlayerWithin](/条件/playerwithin)                     | 位置     | 若玩家与实体的距离在指定范围内                                    |
