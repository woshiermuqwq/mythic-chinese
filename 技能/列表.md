...
| [Goal Ram][]             | 强制施法者（山羊）向技能目标冲撞 | 5.0.3 |
...
| [Power](/实体/威力) | repeati | 该技能的[技能威力](/实体/威力) | 0 | 2.0 |
| [Power Split](/实体/威力) | repeati | 是否将[技能威力](/实体/威力)除以已选取的实体数 | false | 2.0 |
...
| [Force sync](/技能/列表/forcesync) | sync      | 是否在主线程执行 | false   |
