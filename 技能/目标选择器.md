...
| \@LivingEntitiesInRadius{livingonly=true;radius=5} | \@LivingEntitiesInRadius{livingonly=是否排除盔甲架等非生物实体;radius=半径}<br>\@EntitiesInRadius<br>\@AllInRadius<br>\@EIR{l=true;r=5} | 以自身为中心<br>选取指定半径<br>球体范围内的全部实体(包括创造/观察模式玩家) |
