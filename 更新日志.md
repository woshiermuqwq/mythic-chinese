...
### 新增: [Goto](/技能/列表/goto)
- 强制施法者（非玩家）走向技能目标
- 唯一一个一出现就完全支持[占位符](/技能/占位符)与[变量](/技能/变量)的技能
### [On Shoot](/技能/列表/onshoot)
- 修改项: onshootskill 的缩写: os 更名为 osh
### [Orbital](/技能/列表/orbital)
- 修改项: radius(半径)支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Totem](/技能/列表/totem)
- 修改项: maxcharges 支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Consume Slot](/技能/列表/consumeslot)
- 修改项: amount 支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Explosion](/技能/列表/explosion)
- 修改项: yield(爆炸威力) 支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Leap](/技能/列表/explosion)
- 全部修改项 支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Shoot](/技能/列表/shoot)
- 修改项: maxdistance 支持[占位符](/技能/占位符)与[变量](/技能/变量)
###[Damage](/技能/列表/damage)
- 新增可用伤害类型: FALL
...
- 修改项: pitch(音调) 支持[占位符](/技能/占位符)与[变量](/技能/变量)
### [Block Wave](/技能/effects/blockwave)
- 全部修改项支持[占位符](/技能/占位符)与[变量](/技能/变量)
...
### [Shoot](/技能/列表/shoot)
- 修改项: HorizontalOffset 支持[占位符](技能/占位符)与[变量](技能/变量))
- 修改项: VerticalOffset 支持[占位符](技能/占位符)与[变量](技能/变量))
### [Look](/技能/列表/look)
- 现在可工作于 盔甲架
### [Velocity](/技能/列表/velocity)
- 修改项: x, y, z 支持[占位符](/技能/占位符)与[变量](/技能/变量)
...
- 修改项: value 支持[占位符](/技能/占位符)与[变量](/技能/变量)
...
### 新增: [Line Of Sight Origin](/条件/lineofsightorigin)
- 若实体在坐标原点的视野之内
