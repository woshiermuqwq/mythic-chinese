...
| 技能名               | 描述                                                    | 新增于 |
|------------------------|----------------------------------------------------------------| - |
| [Activate Spawner][]   | 激活指定生成点(组)        | 2.0 预览版 |
...
| [Consume][]            | 对技能目标造成伤害后恢复自身生命 | 2.0 预览版 |
...
| [Disguise][]           | 令自身伪装 | 4.12 |
| [Disguise Old][]     | 令自身伪装 | 2.0 预览版 |
| [Disguise Modify][]         | 修改技能目标的伪装 | 4.9 |
| [Disguise Modify New][]         | 修改技能目标的伪装  | 4.9 |
| [Disguise As Block][]     | 令技能目标伪装成方块 | 未知 |
| [Disguise Target][]     | 令技能目标伪装 | 4.9 |
| [Disguise Remove][]         | 取消技能目标的伪装  | 4.9 |
| [Dismount][]           | 取消骑乘              | 2.0 预览版 |
| [Damage][]             | 对技能目标造成伤害(具体数值) | 2.0 预览版 |
| [Base Damage][]         | 对技能目标造成伤害(等值于武器攻击力百分比)      | 2.0 预览版 |
| [Damage Percent][]     | 对技能目标造成伤害(技能目标最大生命百分比)               | 2.0 预览版 |
