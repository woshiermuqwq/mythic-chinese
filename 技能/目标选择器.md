...
| @RingAroundOrigin{radius=半径;points=点数;yoffset=0.0;rotationx=0;rotationy=0;rotationz=0;offsetx=0;offsety=0;offsetz=0}  | @RingOrigin<>@RAO | 以自身为中心<br>在以指定半径所形成的环上<br>规则地选取指定数量的坐标点作为技能目标 （5.0）                                                                                           |
