...
| [Arrow Volley][]       | 在技能目标上方瞬间生成多发箭矢                                       |
| [Aura Remove][]         | 停止技能目标身上的光环                         |
| [Bar Create][]          | 为技能目标创建Boss血条                   |
| [Bar Set][]             | 为技能目标修改Boss血条                  |
| [Bar Remove][]          | 为技能目标移除Boss血条                   |
| [Break Block][]         | 破坏所选取的所有位置的方块                        |
| [Break Block And Give Item][] | 破坏所选取的所有位置的方块后给予额外物品 |
| [Close Inventory][]    | 为技能目标(玩家)关闭背包                           |
| [Command][]            | 执行命令                            |
| [Consume][]            | 对技能目标造成伤害后恢复自身生命                |
| [Consume Slot][]            | 清除技能目标（玩家）指定槽位上指定数量的物品                |
| [Clear Threat][]        | 清除所有对技能目标拥有威胁度的实体                             |
| [Cquip][]                | 穿戴物品（仅可为Mythic物品）                                     |
| [Currency Give][]      | 给予技能目标金钱   |
| [Currency Take][]      | 夺取技能金钱 |
| [Disengage][]          | 向技能目标反向冲刺                               |
| [Disguise][]           | 令自身伪装                                  |
| [Disguise Old][]     | 令自身伪装                                  |
| [Disguise Modify][]         | 修改技能目标的伪装                                   |
| [Disguise Modify New][]         | 修改技能目标的伪装                                   |
| [Disguise As Block][]     | 令技能目标伪装成方块                                  |
| [Disguise Target][]     | 令技能目标伪装                                  |
| [Disguise Remove][]         | 取消技能目标的伪装                                   |
| [Dismount][]           | 取消骑乘              |
| [Damage][]             | 对技能目标造成伤害(具体数值)                               |
| [Base Damage][]         | 对技能目标造成伤害(等值于武器攻击力百分比)      |
| [Damage Percent][]     | 对技能目标造成伤害(技能目标最大生命百分比)               |
| [Decapitate][]         | 掉落技能目标(玩家)头颅                       |
| [Doppleganger][]       | 令自身伪装成技能目标(玩家)                     |
| [Drop Item][]           | 在所选取的所有位置生成掉落物              |
| [Eject Passenger][]    | 取消被骑乘                              |
| [Equip][]                | 穿戴物品(可为原版物品)                      |
| [Explosion][]            | 在技能目标位置生成爆炸                                                         |
| [Extinguish][]           | 熄灭技能目标身上的火                                   |
| [Paste Schematic][]            | 粘贴1个Schematic文件                                               |
| [Feed][]                 | 给予技能目标（玩家）饱和度                                                     |
| [Fill Chest][]            | 用物品与掉落表填充箱子                                    |
| [Fly][]                  | 给予技能目标一个允许飞行的[光环](技能/列表/Aura)                           |
| [Force Pull][]           | 将技能目标传送到自身位置                                             |
| [Freeze][]               | 将技能目标冻结一段时间（有霜冻屏幕效果 需1.17).                |
| [Glow][]                 | 令技能目标发光（需 GlowAPI）                                                       |
| [Give Item][]            | 给予技能目标物品（技能目标背包无空位时无效）                                                |
| [Give Item From Slot][] | 给予技能目标 位于自身指定槽位的物品（技能目标背包无空位时无效） |
| [Give Item From Target][] | 夺取技能目标物品并给予给施法者                                |
| [Go to][]             | 强制施法者（非玩家）走向技能目标                               |
| [Heal][]                 | 恢复技能目标生命(具体数值)                                                            |
| [Heal Percent][]          | 恢复技能目标生命(技能目标最大生命百分比)                         |
| [Hide From Players][] | 令所有玩家在指定时间内无法看见施法者（须为玩家） |
| [Hologram][] | 在技能目标位置召唤悬浮字实体　|
| [Ignite][]               | 点燃技能目标                                                     |
| [JSON Message][]         | 向技能目标(玩家)发送Json信息                         |
| [Jump][]                 | 跳向技能目标                                                   |
| [Leap][]                 | 向技能目标冲刺                                |
| [Lightning][]            | 在技能目标位置生成雷击                                             |
| [Look][]                 | 看向技能目标                                     |
| [Lunge][]                | 朝技能目标冲刺（提供上下速度）                            |
| [Message][]              | 向技能目标(玩家)发送聊天栏信息                                     |
| [Modify Global Score][]  | 修改虚拟技能目标: \_\_GLOBAL\_\_ 在指定记分板上的分数                                          |
| [Modify Target Score][]  | 修改技能目标在指定记分板上的分数                                   |
| [Modify Score][]         | 修改虚拟技能目标在指定记分板上的分数                                       |
| [Mount][]                | 生成MythicMobs实体并骑乘                                  |
| [Mount Me][]             | 令技能目标骑上施法者                                |
| [Mount Target][]         | 令施法者骑上技能目标                                                           |
| [Oxygen][]               | 给予技能目标(玩家)氧气                                             |
| [Play Animation][] | 令技能目标播放指定动作（≥1.17） |
| [Play Block Break Sound][] | 播放技能目标位置的方块的破坏音效 |
| [Play Block Hit Sound][] | 播放技能目标位置的方块的挖掘音效 |
| [Play Block Place Sound][] | 播放技能目标位置的方块的放置音效 |
| [Play Block Step Sound][] | 播放技能目标位置的方块的踩踏音效 |
| [Pose Armor Stand][]       | 修改技能目标（盔甲架）姿势（需 Animate Armor Stands）                                   |
| [Potion][]               | 将状态效果应用于技能目标                                       |
| [Potion Clear][]          | 清除技能目标全部的状态效果                               |
| [Prison][]               | 令技能目标困在由方块组成的空间内                                         |
| [Propel][]           | 朝技能目标冲刺（提供上下速度）                                  |
| [Pick Up Item][]           | 拾取技能目标（掉落物实体）                                  |
| [Pull][]                 | 强制技能目标往施法者位置移动                                            |
| [Push Button][]           | 按下所选取的所有位置的按钮                                      |
| [Rally][]                | 令范围内的所有指定实体选取技能目标为技能目标                               |
| [Random Message][]       | 随机发送多条聊天栏信息中的一条给技能目标(玩家)                                 |
| [Remount][]              | 重新骑上坐骑(若坐骑存活) |
| [Remove][]               | 移除技能目标(非玩家)                                                      |
| [Remove Held Item][]       | 移除技能目标指定数量的手持物品                       |
| [Remove Owner][]          | 令狼忘记主人                                     |
| [Run AI Goal Selector][] | 修改技能目标（非玩家）的AI行动器                                                    |
| [Run AI Target Selector][] | 修改技能目标（非玩家）的AI技能目标选择器                                              |
| [Send Action Message][]    | 发送活动栏信息给技能目标(玩家)                           |
| [Send Resource Pack][]     | 发送资源包下载链接给技能目标(玩家)                                |
| [Send Title][]     | 发送标题信息给技能目标(玩家)                       |
| [Send Toast][]             | 发送进度信息给技能目标(玩家)                           |
| [Set AI][]                 | 开关技能目标(非玩家)的AI                                 |
| [Set Block Type][]         | 修改所选取的所有位置的方块种类                                      |
| [Set Colliable][]          | 设置技能目标(非玩家)是否拥有碰撞箱                                   |
| [Set Game Mode][]          | 修改技能目标(玩家)的游戏模式                                   |
| [Set Gliding][]            | 设置技能目标身上的鞘翅飞行状态                                |
| [Set Global Score][]       | 设置虚拟玩家: \_\_GLOBAL\_\_ 在指定记分板的分数                                            |
| [Set Gravity][]            | 设置技能目标(非玩家)是否拥有重力                            |
| [Set Health][]             | 设置技能目标(非玩家)的当前生命                                      |
| [Set Level][]              | 设置MythicMobs实体的等级                                           |
| [Set Max Health][]         | 设置技能目标(非玩家)的最大生命                                  |
| [Set Mob Color][]          | 设置技能目标(特定实体)的外观颜色                  |
| [Set Mob Score][]          | 设置技能目标在指定记分板上的分数                                |
| [Set Name][]               | 设置技能目标(非玩家)的显示名                                          |
| [Set No Damage Ticks][]      | 设置技能目标的受伤间隔                                      |
| [Set Owner][]              | 设置技能目标为施法者的主人                             |
| [Set Rotation][]           | 设置技能目标朝向（不能为玩家）                                           |
| [Set Target Score][]       | 设置技能目标在指定记分板上的分数                                              |
| [Set Score][]              | 设置虚拟玩家在指定记分板上的分数                               |
| [Set Speed][]              | 设置技能目标（非玩家）在指定移动状态下的移动速度                                  |
| [Set Stance][]             | 设置技能目标（非玩家）的当前姿势                                         |
| [Shield][]                 | 给予技能目标黄心                             |
| [Shield Break][]                 | 令技能目标所持的盾牌进入指定秒数的冷却                             |
| [Shield Percent][]          | 给予技能目标黄心(技能目标最大生命百分比) |
| [Shoot Fireball][]         | 向技能目标发射火球                                           |
| [Shoot Potion][]           | 向技能目标投掷药水瓶                                             |
| [Shoot Skull][]            | 向技能目标发射凋灵头颅                                      |
| [Shoot Shulker Bullet][]   | 向技能目标发射潜影贝导弹                              |
| [Signal][]                 | 向技能目标发送信号                                                   |
...
| [Suicide][]      | 令施法者自杀                                                            |
| [Summon][]       | 在技能目标位置生成实体                                                    |
| [Summon Area Effect Cloud][]       |  在技能目标位置生成药水云
| [Swap][]         | 与技能目标互换位置                                                     |
| [Switch][]         | 检测给定条件的给定修改项的值, 并激活相对应的技能                                                     |
| [Add Tag][]      | 给予技能目标标签                                                 |
| [Remove Tag][]   | 移除技能目标的指定标签                                             |
| [Teleport][]     | 传送到(技能目标                                                             |
| [TeleportIn][]   | 将指定技能目标传送到自身位置,可调整位置偏移.                                   |
| [TeleportTo][]   | 将技能目标传送到所选取的所有位置                                        |
| [Threat][]       | 修改技能目标对于施法者的威胁度                                        |
| [Throw][]        | 击退技能目标                                                            |
| [Toggle Lever][] | 开关所选取的所有位置的拉杆                                              |
| [Toggle Sitting][] | 令技能目标(特定实体)坐下/站起                      |
| [Track Location][] | 记录技能目标的当前位置
| [Velocity][]     | 设置技能目标的当前动量                                       |
| [Weather][]      | 修改技能目标所处世界的天气                                           |
| [WolfSit][]      | 令技能目标(狗)坐下                                                 |
...
| **[Skill][]**       | 向技能目标激活指定技能组                                       |
| [Aura][]            | 给予技能目标光环 |
| [Cancel Event][]     | 取消对应的触发器事件                                  |
| [Cast][]            | 给予施法者用于激活多个技能组的光环 |
| [Chain][]           | 在多个技能目标之间传递指定技能组                       |
| [Chain Missile][]    | 在多个技能目标之间传递导弹(Missile)                |
| [Delay][]           | 延迟多少刻后激活技能行                                              |
| [Global Cooldown][] | 设置施法者的全局冷却（不同于各技能独立的冷却）                                                 |
| [Missile][]         | 向技能目标发射追踪抛射物                                                       |
| [Modify Projectile][] | 修改已发射的抛射/弹射物与环绕                                   |
| [On Attack][]        | 给予技能目标光环(光环持有者近身攻击后激活技能组)                 |
| [On Block Break][]       | 给予技能目标光环(光环持有者成功挖掘方块后激活技能组)            |
| [On Block Place][]       | 给予技能目标光环(光环持有者放置方块后激活技能组)            |
| [On Damaged][]       | 给予技能目标[光环](技能/列表/Aura)(光环持有者受到任何形式的伤害后激活技能组)            |
| [On Interact][]         | 给予技能目标光环(光环持有者被交互后激活技能组)            |
| [On Jump][]        | 给予技能目标光环(光环持有者跳跃后激活技能组)                 |
| [On Death][]       | 给予技能目标[光环](技能/列表/Aura)(光环持有者死亡后激活技能组)            |
| [On Shoot][]         | 给予技能目标光环(光环持有者射击后激活技能组)            |
| [On Swing][]         | 给予技能目标光环(光环持有者左键后激活技能组)            |
| [Orbital][]         | 生成抛射物环环绕技能目标                 |
| [Projectile][]      | 向技能目标发射抛射物                               |
| [Shoot][]           | 向技能目标发射弹射物                                                  |
| [Volley][]            | 从施法者位置向技能目标发射指定数量的弹射物 |
| [Ray Trace][]         | 从施法者向技能目标发射射线            |
| [Ray Trace To][]         | 从施法者位置向技能目标发射射线            |
| [Sudo Skill][]         | 令技能目标作为施法者激活技能                                       |
| [Random Skill][]      | 向技能目标激活多个技能组内的随机一个                                    |
| [Totem][]             | 生成浮空且跟随施法者的Mythic实体  |
| [Variable Add][]      | 增加变量值                                   |
| [Variable Math][]     | 计算变量值                                    |
| [Variable Set][]      | 创建变量(若存在则替换)                                           |
| [Variable Unset][]    | 移除变量                                                   |
...
这些修改项可用于所有技能,且全部支持[变量](技能/变量)  
20tick=1秒.

| 修改项名      | 缩写 | 描述                                    | 默认值 |
|----------------|-----------|------------------------------------------------|---------|
| [cooldown](技能/列表/cooldown)       | cd        | 冷却时间(秒)                                     | 0       |
| [delay](技能/列表/delay)          |           | 延迟(刻)           | 0       |
| [repeat](技能/列表/repeat)         |           | 重复激活次数 | 0       |
| [repeatInterval](技能/列表/repeat) |           | 重复激活间隔(刻) | 0       |
...
| [Time][]           | 修改技能目标所处世界的时间                |
  ...
  [Set Colliable]: /技能/列表/setcolliable
