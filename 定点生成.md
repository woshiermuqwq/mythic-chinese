...
通过定义 radius 与 maxmobs 以令生成点做到类似于刷怪笼的效果.
...
|**radius: 数值**|所生成实体离生成点的最大水平距离(格方块)| /mm s set 生成点名 radius 数值|0|
|**radiusY: 数值**|所生成实体离生成点的最大垂直距离围(格方块)| /mm s set 生成点名 radiusy 数值|0|
