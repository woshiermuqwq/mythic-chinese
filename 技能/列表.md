...
| [Remove Trade][]   | 为技能目标(村民)移除最近添加的交易条目  | 5.3.0 |
| [Replace Trade][]   | 为技能目标(村民)替换最近添加的交易条目  | 5.3.0 |
...
| [Set Parent]   | 令技能目标避开指定类型的方块 | 5.2.0 |
...
| [Skill On Cooldown](/技能/列表/SkillOnCooldown) | | 若执行技能组时技能组仍在冷却, 则执行指定技能组 |
  ...
  [Remove Trade]: /技能/列表/removetrade
  [Replace Trade]: /技能/列表/replacetrade
