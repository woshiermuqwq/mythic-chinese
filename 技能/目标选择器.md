...
| \@LivingEntitiesInRadius{livingonly=true;radius=5} | \@LivingEntitiesInRadius{livingonly=是否排除箭矢等非生物实体;radius=半径}<br>\@EntitiesInRadius<br>\@AllInRadius<br>\@EIR{l=true;r=5} | 以自身为中心, 选取指定半径<br>球体范围内的全部实体(包括创造/观察模式玩家)<br>选项: livingonly 新增于 MM 4.13, 也就是说在这之前技能不可能选取箭矢等实体 |
