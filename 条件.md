...
| [In Combat](/条件)   |  | 实体 |  | 若处在战斗状态下      |
| [Inside](/条件)                                 |  | 位置 |  | 若头上有方块                   |
| [Is Caster](/条件)                             |  | 实体 | 4.12 | 若为施法者           |
| [Is Child](/条件)                               |  | 实体 | 4.12 | 若为施法者的子系实体 |
| [Is Parent](/条件)                               |  | 实体 | 4.12 | 若为施法者的父系实体 |
| [Is Living](/条件)                             |  | 实体 | 4.12 | 若为实体 |
| [Is Leashed](/条件)                             |  | 实体 | 5.0.5 | 若实体被拴绳拴住    |
| [Is Monster](/条件)                           |  | 实体 | 4.12 | 若实体种类为为怪物 |
| [Is Player](/条件)                             |  | 实体 | 4.12 | 若为玩家 |
| [Is Sprinting](/条件/issprinting)                       | sprinting | 实体 |  | 若玩家正在疾跑 |
