...
| [On Attack][]        | 给予目标光环(光环持有者近身攻击后激活技能组)                 |
| [On Block Break][]       | 给予目标光环(光环持有者成功挖掘方块后激活技能组)            |
| [On Block Place][]       | 给予目标光环(光环持有者放置方块后激活技能组)            |
| [On Damaged][]       | 给予目标[光环](技能/列表/Aura)(光环持有者受到任何形式的伤害后激活技能组)            |
| [On Interact][]         | 给予目标光环(光环持有者被交互后激活技能组)            |
| [On Death][]       | 给予目标[光环](技能/列表/Aura)(光环持有者死亡后激活技能组)            |
| [On Shoot][]         | 给予目标光环(光环持有者射击后激活技能组)            |
| [On Swing][]         | 给予目标光环(光环持有者左键后激活技能组)            |
