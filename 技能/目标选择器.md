...
| 目标选择器名                          | 缩写    | 注释                                              |
|--------------------------------------|--------------------|----------------------------------------------------------------------------------------------------------|
| @LivingInCone{a=弧度;r=母线长度;rot=圆锥体的母线起始角度} | @EIC{a=90;r=16;rot=0.0}, EntitiesInCone, LEIC             | 选取位于<br>指定弧度<br>指定半径<br>指定母线起始角度<br>顶点垂直偏移为0.0格方块<br>所形成的圆锥体范围内的所有实体 |
...
| @Cone{angle=90;points=点数;range=2;rotation=10;yoffset=0.0} |  | 随机选取<br>弧度为180<br>半径为2<br>母线起始角度为10<br>顶点垂直偏移为0.0格方块<br>所形成的圆锥体范围内<br>指定数量的坐标点作为技能目标 |
