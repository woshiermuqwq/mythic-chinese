...
| @Children                             |         | 子系实体                                          |
| @Passenger                            |         | 施法者的骑乘者                                  |
| @PlayerByName{name="Ashijin"}（4.12）         |         | 名称为指定字符串的玩家,支持变量        |
...
| @ForwardWall（5.0） | | 当前朝向正前方的墙 |
| @TargetLocation        | @targetloc, @TL       | 技能目标的位置                                                                                                                                                                                                                |
...
| @CasterSpawnLocation（5.0）                  |         | 施法者的出生点                                      |
| @SpawnLocation（5.0）                  |         | 所处世界的世界出生点                                      |
...
| @Ring{radius=半径;points=点数;yoffset=0.0}              |             | 以点数形成一个图形,选取该图形（从5.0开始支持变量与占位符）                                                                                           |
...
| @BlocksInRadius{radius=#;radiusy=#;noise=#;shape=形状sphere/cube;onlyair=是否仅选取空气false;noair=true}（5.0） |     | 选取半径范围内的所有方块 |
