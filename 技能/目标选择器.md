...
| @Forward{f=5;y=0.0;sideOffset=0.0;rotation=0.0}    |           | 选取 当前朝向 正前方第5格方块位置且垂直偏移0.0格方块, 左右偏移0.0格位置的方块                                                                                                                                                                        |
| @ForwardWall{length=}（4.13） | | 选取 当前朝向 正前方第5格方块位置且垂直偏移0.0格方块, 左右偏移0.0格位置的"一面墙" |
