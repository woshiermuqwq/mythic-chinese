...
| [Food Level](/条件/FoodLevel)                           | 实体     | 若实体的饱食度在指定范围内                                            |
...
| [Has AI](/条件/hasai)（5.1.0）                             | 实体     | 若实体拥有AI                                                        |
| [Has Aura](/条件/hasaura)                               | 实体     | 若实体拥有指定光环                                              |
...
| [Has Offhand](/条件/hasoffhand) (5.1.0)                           | 实体     | 若实体的副手槽不为空                                                         |
...
| [Line Of Sight](/条件/lineofsight)                       | 比较     | 若技能目标与施法者之间存在视觉障碍物.                                   |
| [Line Of Sight From Origin](/条件/lineofsightfromorigin)                       | 比较     | 若技能目标与坐标原点之间存在视觉障碍物.                                   |
...
| [Plugin](/条件/plugin)                     | 服务端     | 若服务端已安装指定插件                   |
