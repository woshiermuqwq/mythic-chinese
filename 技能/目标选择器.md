...
实体配置内的技能行无目标选择器时, 默认使用 @self（绝大多数技能）
...
| @PlayersNearOrigin{r=半径}              |  @PlayersNearSource | 以坐标原点为中心<br>选取指定半径<br>球体范围内的所有玩家 |
...
| 目标选择器名        | 缩写      | 注释                                                        |
|-------------------------------------------------|-------------|--------------------------------------------------------------------------------------------------------------------------------------|
| @PlayerLocationsInRadius{r=半径}                  | @PLIR{r=#}<>@PLR<>@LocationRadius | 以自身位置为中心<br>选取指定半径 球体范围内的所有玩家                                                                                     |
...
| @LivingNearTargetLocation{radius=5}    | @LivingEntitiesNearTargetLocation<br>@LNTL{r=半径}               | 以技能目标为中心<br>选取指定半径<br>球体范围内的全部实体                                                                                                                                                                                                                                                                                                                                     |
