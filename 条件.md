...
| [Blocking](/条件)                             | isblocking | 实体 |  | 若正在使用盾格挡                                        |
| [Burning](/条件)                               | isburning, isonfire | 实体 |  | 若正在燃烧 |
| [Charged](/条件)                             | ischarged | 实体 | 4.14.2 | 若已充能（爬行者）                                                     |
| [Children](/条件/children)                             |  | 实体 | 4.9 | 若拥有指定数量的子系实体                                                     |
| [Color](/条件/color)                                   |  | 实体 | 4.13.1 | 若实体颜色为 |
| [Crouching](/条件/crouching)                           | iscrouching, issneaking, sneaking | 实体 |  | 若处在蹲下状态               |
...
| [Dawn](/条件)                                     |  | 位置 |  | 若所处世界处于白昼(2000到22000)           |
| [Day](/条件)                                       |  | 位置 |  | 若所处世界处于白天(2000到10000)   |
| [Dusk](/条件)                     |  | 位置 |  | 若所处世界处于黄昏(14000到18000)    |
...
| [Distance From Tracked Location](/条件/distancefromtrackedlocation) | 位置 | 4.13 | 若实体与所保存位置之间的距离在指定范围内 |
...
| [Ender Dragon Phase](/条件/EnderDragonPhase)             | edragonphase | 实体 | 4.10 | 若末影龙动作阶段为                                           |
