...
| @Cone{angle=90;points=点数;range=2;rotation=10;yoffset=0.0} |  | 随机选取<br>弧度为180<br>半径为2<br>起始角度为10<br>中心点垂直偏移为0.0格方块<br>所形成的扇形范围内<br>指定数量的坐标点作为技能目标 |
| @EntitiesInCone{angle=角度;range=母线长度;rotation=起始点旋转角度;} |  | 选取以指定角度<br>指定母线长度<br>指定起始点旋转角度<br>所形成扇形内的所有实体                                                                                                |
