...
| [On Attack][]        | 给予目标光环(目标近身攻击后激活技能组)                 |
| [On Block Break][]       | 给予目标光环(目标成功挖掘方块后激活技能组)            |
| [On Block Place][]       | 给予目标光环(目标放置方块后激活技能组)            |
| [On Damaged][]       | 给予目标[光环](技能/列表/Aura)(受到任何形式的伤害后激活技能组)            |
| [On Death][]       | 给予目标[光环](技能/列表/Aura)(死亡后激活技能组)            |
| [On Shoot][]         | 给予目标光环(目标射击后激活技能组)            |
| [Orbital][]         | 生成抛射物环环绕目标                 |
...
| [Time][]           | 修改目标所处世界的时间                |
  ...
  [Remove]: /技能/列表/remove
  [Remove HeldItem]: /技能/列表/removehelditem
